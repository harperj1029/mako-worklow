...
const WorkflowNav = ({onNavigate, allowPrevious, allowNext}) => (<div>
    <button type="button" form="steps" disabled={!allowPrevious} className="btn btn-secondary" onClick={() => onNavigate("previous")}>
        <span className="fa fa-chevron-left" style={{marginRight: "5px"}}></span>Previous
    </button>
    <button type="button" form="steps" disabled={!allowNext} className="btn btn-secondary" onClick={() => onNavigate("next")}>
        Next
